...
def load_data():
    ...
    return ref_energ_kcal, ref_carbo_g, ref_prot_g, ref_gord_sat_g, ref_fibra_g, ref_sod_mg, ref_colest_mg, ref_calcio_mg, ref_ferro_mg, ref_potassio_mg, ref_vit_k_mg, dados

ref_energ_kcal, ref_carbo_g, ref_prot_g, ref_gord_sat_g, ref_fibra_g, ref_sod_mg, ref_colest_mg, ref_calcio_mg, ref_ferro_mg, ref_potassio_mg, ref_vit_k_mg, dados = load_data()
nomes = list(dados.keys())

paginas = ["Início", "Análise Descritiva Produtos","Análise Descritiva Prato","Sobre o Desenvolvedor"]
